...
- [x] M4: 分析エンジンPoC（実音源での採譜＋アライメント精度検証）← **いまここ**
- [ ] M5: 本実装
...
M3・M4 の成果物は [`docs/`](./docs/README.md) にあります。
...
`poc/` に M4 の検証スクリプト一式があります。実行手順は
[M4 検証レポート 8章](./docs/poc/m4-report.md#8-再現手順) を参照してください。
